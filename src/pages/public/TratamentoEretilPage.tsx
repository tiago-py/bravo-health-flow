          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Recupere sua <span className="text-yellow-600">performance</span> e <span className="text-yellow-600">confiança</span>
              </h1>
            ...
            <div className="md:w-1/2">
              <img alt="Homem confiante" className="w-full rounded-lg shadow-lg" src="/lovable-uploads/505ab698-7d6d-447a-b70d-a90775f7d212.png" />
            </div>
          </div>
        </div>
      </section>
